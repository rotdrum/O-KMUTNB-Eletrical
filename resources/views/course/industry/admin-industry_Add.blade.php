...
@section('content')
    <div class="vue-container">
        ...
        {{-- Card --}}
        <form class="card-main" id="usrform" method="POST" action="{{ route('postindustryAdd') }}"  enctype="multipart/form-data">
        @csrf
            <div class="admin-editAboutDepartment">
                ...
                <textarea required name="comment" id="area" name="comment" form="usrform" placeholder="แก้ไขเนื้อหา"></textarea>
