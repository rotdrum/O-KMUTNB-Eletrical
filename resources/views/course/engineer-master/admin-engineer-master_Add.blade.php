...
@section('content')
    <div class="vue-container">
        ...
        {{-- Card --}}
        <form class="card-main" id="usrform" method="POST" action="{{ route('postengineerMasterAdd') }}"  enctype="multipart/form-data">
            @csrf
            <div class="admin-editAboutDepartment">

                <h4>*เนื้อหารายละเอียด</h4>
                <input type="text" required name="title" class="txt-edit" placeholder="แก้ไขหัวข้อหลัก">
