...
@section('content')
    <div class="vue-container">
        ...
        {{-- Card --}}
        <form class="card-main" id="usrform"  method="POST" action="{{ route('postengineerEdit') }}"  enctype="multipart/form-data">
        @csrf
            <div class="admin-editAboutDepartment">
                ...
                <div class="admin-text2">
                    <input type="text" name="title_file" value="{{ $engineer->title_file }}"  name="title_file" class="txt-edit2" placeholder="เช่น ดาวโหลดเอกสารหลักสูตรปริญญาตรี">
                    <input type="text" name="url" value="{{ $engineer->url }}"  name="url" class="txt-edit2" placeholder="เพิ่ม URL">
                </div>
