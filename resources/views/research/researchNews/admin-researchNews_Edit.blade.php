...
@section('content')
    <div class="vue-container">
        ...
        {{-- Card --}}
        <form class="card-main" method="POST" action="{{ route('postresearchNewsEdit', ['id'=>$new->id]) }}"  enctype="multipart/form-data" id="usrform">
            @csrf
            ...
            <div class="avatar-upload">
                ...
                <div class="avatar-preview">
                    <div id="imagePreview" style="background-image: url('{{asset('storage/')}}/../../storage/app/public/research_news/pic/{{ $new->pic }}');">
                    </div>
                </div>
            </div>
