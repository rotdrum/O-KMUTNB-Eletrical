...
@section('content')
    <div class="vue-container">
        ...
        <form class="researchManage-card">
            <input type="text" class="txt-researchManage" value="รหัสโปรเจค : 12345" readonly>
            ...
            <input type="text" class="txt-researchManage" placeholder="กรอกชื่อโปรเจค (ภาษาไทย)">
            <input type="text" class="txt-researchManage" placeholder="กรอกชื่อโปรเจค (ภาษาอังกฤษ)">
            <div class="rm-50">
                <select>
            ...
            <select class="selDepartment">
                ...
                <option value="">ปริญญานิพนธ์สมบูรณ์</option>
            </select>
