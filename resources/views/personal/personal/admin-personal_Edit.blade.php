...
@section('content')
    ...
    <form class="vue-container" method="POST" action="{{ route('postpersonalEdit') }}"  enctype="multipart/form-data">
    @csrf
                ...
                <div class="profile-card">
                    ...
                    <div class="avatar-upload">
                        ...
                        <div class="avatar-edit-profile">
                            <input   type='file' id="imageUpload" name="pic_name" accept=".png, .jpg, .jpeg" />
            ...
            <div class="profile-right">
                ...
                <div class="profile-card">
                    ...
                    <div class="profile-detail">
                        <p>ชื่อ-สกุล (ไทย)</p>
                        <input required value="{{ $personal->name_thai }}"  type="text" name="name_thai" id="firstname" placeholder="ชื่อ-นามสกุล (ไทย)" oninput="displayName.value = firstname.value">
                    </div>
                    <div class="profile-detail">
                        <p>ชื่อ-สกุล (อังกฤษ)</p>
                        <input required value="{{ $personal->name_eng }}" type="text" name="name_eng" placeholder="ชื่อ-นามสกุล (อังกฤษ)">
                    </div>
                    <div class="profile-detail">
                        <p>ตำแหน่ง</p>
                        <select required  class="sel-room" name="position" >
                            <option value="{{ $personal->position }}">{{ $personal->position }}</option>
                    ...
                    <div class="profile-detail">
                        <p>ชื่อย่อ</p>
                        <input required value="{{ $personal->initial }}"  type="text" name="initial" placeholder="XXX">
                    </div>
                    <div class="profile-detail">
                        <p>อีเมล</p>
                        <input required value="{{ $personal->email }}" type="text" name="email" placeholder="example@cit.kmutnb.ac.th">
                    </div>
                    <div class="profile-detail">
                        <p>ติดต่อ</p>
                        <input required value="{{ $personal->contact }}" type="text" name="contact" placeholder="เช่น ห้องพักครู">
                    </div>
                    <div class="profile-detail">
                        <p>โทรศัพท์</p>
                        <input required value="{{ $personal->tel }}"  type="text" name="tel" placeholder="0X-XXX-XXXX">
                    </div>
                </div>
                ...
                <div class="profile-card" >
                    ...
                    <div id="edu">
                        <div class="profile-detail">
                            ...
                            <input value="{{ $personal->bachelor }}" name="bachelor" type="text" placeholder="วิทยาลัยเทคนิคอุตสาหกรรม">
                        </div>
                    </div>
                    ...
                    <div id="edu">
                        <div class="profile-detail">
                            ...
                            <input value="{{ $personal->master }}" name="master" type="text" placeholder="วิทยาลัยเทคนิคอุตสาหกรรม">
                        </div>
                    </div>
                    ...
                    <div id="edu">
                        <div class="profile-detail">
                            ...
                            <input value="{{ $personal->phd }}" name="phd" type="text" placeholder="วิทยาลัยเทคนิคอุตสาหกรรม">
                        </div>
                    </div>
                ...
                <div class="profile-card">
                    ...
                    <div id="subject">
                        <div class="profile-detail">
                            <input value="{{ $personal->edu1 }}" name="edu_s1" type="text" placeholder="Electrical Works and Instrument">
                        </div>
                    </div>
                    <div id="subject">
                        <div class="profile-detail">
                            <input value="{{ $personal->edu2 }}" name="edu_s2"  type="text" placeholder="Electrical Works and Instrument">
                        </div>
                    </div>
                    <div id="subject">
                        <div class="profile-detail">
                            <input value="{{ $personal->edu3 }}" name="edu_s3"  type="text" placeholder="Electrical Works and Instrument">
                        </div>
                    </div>
                    <div id="subject">
                        <div class="profile-detail">
                            <input value="{{ $personal->edu4 }}" name="edu_s4"  type="text" placeholder="Electrical Works and Instrument">
                        </div>
                    </div>
                    <div id="subject">
                        <div class="profile-detail">
                            <input value="{{ $personal->edu5 }}" name="edu_s5"  type="text" placeholder="Electrical Works and Instrument">
                        </div>
                    </div>
                    {{-- 
                    <a class="add-subject">
                ...
                <div class="profile-card">
                    ...
                    <div class="admin-text3">
                        <label for="file-upload-1">อัพโหลดไฟล์
                            <input   name="file_name"  type="file" id="file-upload-1" accept=".pdf" class="file-upload">
                        </label>
